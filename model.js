...
// transform document to add localRankHash property. 
...
// transform document to add user information of the user who has used the invitation
...
if (Meteor.isClient) {
  ...
  DynamicClasses = new Meteor.Collection(null);
