...
var fields = function() {
  return [
    ...
    { key: 'biography', label: 'bio', fn: function(bio) { return bio ? Safe.string('<span class="icon icon-leaf" title="'+bio+'" style="cursor:help;"></span>') : ''; } },
    { key: 'company', label: 'comp.', fn: function(company) { return company ? Safe.string('<span class="icon icon-briefcase" title="'+company+'" style="cursor:help;"></span>') : ''; } },
    { key: 'location', label: 'loc.', fn: function(location) { return location ? Safe.string('<span class="icon icon-map-marker" title="'+location+'" style="cursor:help;"></span>') : ''; } },
    
    { key: 'website', label: 'site', sortByValue: true, fn: function(url) { return url ? Safe.url(url, {text: '<span class="icon icon-globe"></span>'}) : ''; }},
